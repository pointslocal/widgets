...
var Pointslocal = function(element,opts,cb) {
  ...
  this.construct = function(opts) {
    ...
    this.path = plself.resolvePath(opts.site);
    ...
    $.getJSON(call, (function(self) {
      // console.log(plself.template);
        return function (d) {
          ...
          d['contextURL'] = plself.contextURL || false;
